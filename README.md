...
This repository includes reusable packages for building Shopify Partner marketplace applications:

### @shopify-marketplace/partner-app-utils

A comprehensive utilities package that provides:
- API clients for Admin, Market, and Buyer applications
- Configuration management for multi-app setups
- Health monitoring and status checking
- TypeScript types and interfaces
- Mock data for development and testing
- Automatic retry logic and error handling

See [PACKAGES.md](./PACKAGES.md) for detailed information about using and managing packages in this monorepo.

## Formal Specification

This project includes a comprehensive formal specification written in Z++ notation:

- **[📚 Specification Index](docs/FORMAL_SPECIFICATION_INDEX.md)** - Complete navigation guide (start here!)
- **[📝 Z++ Notation Reference](docs/Z++_NOTATION_REFERENCE.md)** - Quick reference card (print this!)
- **[⭐ Formal Specification](docs/FORMAL_SPECIFICATION.zpp)** - Complete Z++ specification (850+ lines)
- **[📖 Specification Guide](docs/FORMAL_SPECIFICATION_GUIDE.md)** - How to read and use the specification
- **[🚀 Quick Reference](docs/FORMAL_SPECIFICATION_README.md)** - Overview and integration guide
- **[✅ Validation Examples](docs/FORMAL_SPECIFICATION_VALIDATION.md)** - Test patterns and validation code
- **[📊 Summary](docs/Z++_SPECIFICATION_SUMMARY.md)** - High-level summary and benefits

The formal specification provides:
- Precise mathematical definitions of system behavior (15 sections, 35+ schemas)
- Operation preconditions and postconditions (20+ operations)
- System invariants and constraints (30+ invariants)
- Basis for verification and formal testing
